...
int main()
{
	...
	AnsiGL::Surface::Ptr AnsiGLScr = std::make_shared< AnsiGL::Surface >( AnsiGL::Area(COLS, LINES) );
	...
	AnsiGL::Context::Ptr MyContext = std::make_shared< AnsiGL::Context >( ViewportSize, ViewportPos );
	...
	*Instructions << "Quit:              q\n";
	...
	AnsiGL::Context::Ptr MySecondContext = std::make_shared< AnsiGL::Context >( ViewportSize, ViewportPos );
